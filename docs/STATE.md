...
Correct and review the native transport defect, resume sources/scope, then complete parser, providers, matrix/jobs/research, MCP, exports and distribution as recorded in the plan. NATIVE_VALIDATION_PLAN.md pins the engine payload, isolated paths and checks. The user explicitly authorized its isolated launch/install/preferences/API/DOM test exception on2026-09-05. Personal-profile plugin installation is not authorized.

## Public project repository

The user requested `Evidra-zotero` on GitHub and corrected its visibility to public. Created https://github.com/Marcux777/Evidra-zotero and pushed reviewed committed state `344fbc1f1dbdf59680f8ad6852434622a30090e9` to `main`; remote ref and visibility were verified. Uncommitted Task3 work remains local until reviewed. The same public repository hosts the separately authorized empty update feed, verified200/exact77bytes/SHA256 `901686d6fab93aba6f5b115b5002f7fa630af72c09a2d59402b15549c14bd96a`. No release binary or ignored local cache/database was published. See UPDATE_FEED_PROPOSAL.md and `.local/publication/first-publication.json`.

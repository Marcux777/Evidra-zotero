  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (_errs1 === errors) {
        ...
        if (valid0) {
          if (data.include_selected_containers !== void 0) {
            const _errs18 = errors;
            if (typeof data.include_selected_containers !== "boolean") {
              validate21.errors = [{ instancePath: instancePath + "/include_selected_containers", schemaPath: "#/properties/include_selected_containers/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" }];
              return false;
            }
                            ...
                            if (valid0) {
                                      ...
                                      for (let i3 = 0; i3 < len3; i3++) {
                                        ...
                                        if (errors === _errs53) {
                                          if (data18 && typeof data18 == "object" && !Array.isArray(data18)) {
                                            let missing1;
                                            if (data18.profile_instance_id === void 0 && (missing1 = "profile_instance_id") || data18.library_id === void 0 && (missing1 = "library_id") || data18.item_key === void 0 && (missing1 = "item_key")) {
                                              ...
                                              if (_errs55 === errors) {
                                                if (data18.profile_instance_id !== void 0) {
                                                  let data19 = data18.profile_instance_id;
                                                ...
                                                if (valid11) {
                                                  if (data18.library_id !== void 0) {
                                                    let data20 = data18.library_id;
                                                  ...
                                                  if (valid11) {
                                                    if (data18.item_key !== void 0) {
                                                      let data21 = data18.item_key;
                              ...
                              if (valid0) {
                                if (data.attachment_roles !== void 0) {
                                  let data22 = data.attachment_roles;
                                  const _errs62 = errors;
                                  if (errors === _errs62) {
                                    if (Array.isArray(data22)) {
                                      if (data22.length > 1e3) {
                                        ...
                                        for (let i4 = 0; i4 < len4; i4++) {
                                          ...
                                          if (!validate22(data22[i4], { instancePath: instancePath + "/attachment_roles/" + i4, parentData: data22, parentDataProperty: i4, rootData, dynamicAnchors })) {
